...
class Config(object):
    # pyro client config
    API_ID    = os.environ.get("API_ID", "21406473")
    API_HASH  = os.environ.get("API_HASH", "5be36a07edbc5e0effecc6298a626c96")
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7803358226:AAGJdq63prJB8-MWWLi5GylnZQFZgM79_0k") 
   
    # database config
    DB_NAME = os.environ.get("DB_NAME","Cluster0")     
    DB_URL  = os.environ.get("DB_URL","mongodb+srv://jamessmithssp:jamessmithssp@cluster0.lemow.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")

    # other configs
    BOT_UPTIME  = time.time()
    START_PIC   = os.environ.get("START_PIC", "https://envs.sh/jUp.jpg")
    ADMIN = [int(admin) if id_pattern.search(admin) else admin for admin in os.environ.get('ADMIN', '8078089503').split()]

    # channels logs
    FORCE_SUB   = os.environ.get("FORCE_SUB", "TechifyBots") 
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002246863198"))
    BIN_CHANNEL = int(os.environ.get("BIN_CHANNEL", "-1002279798502"))
